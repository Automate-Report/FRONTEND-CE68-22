    ...
    return (
        <div className="w-full max-w-md rounded-2xl border-3 border-[#9AA6A8] shadow-lg p-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                    type="submit"
                    className="mt-6 w-full flex items-center justify-center bg-[#8FFF9C] text-[#0B0F12] text-[16px] 
                    font-bold rounded-lg px-6 py-2 gap-3 cursor-pointer hover:shadow-[0_0_18px_rgba(34,197,94,0.9)]"
                >
                    Create Account
                </button>
            ...
            <button
                ...
                type="button"
                className="mt-6 w-full flex items-center justify-center bg-[#FBFBFB] text-[#404F57] text-[16px] 
                    font-bold rounded-lg px-6 py-2 gap-3 cursor-pointer hover:shadow-[0_0_18px_rgba(255,255,255,0.5)]"
            >
