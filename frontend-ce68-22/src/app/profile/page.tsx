                    ...
                    <Link href="/profile/edit">
                        <button className="flex items-center gap-3 rounded-lg bg-[#8fff9c] px-6 py-2 text-sm font-bold text-[#0b0f12] cursor-pointer">
                            ...
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="M5.8335 14.1667V10.8333L14.1668 2.5L17.5002 5.83333L9.16683 14.1667H5.8335Z" stroke="#0B0F12" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
