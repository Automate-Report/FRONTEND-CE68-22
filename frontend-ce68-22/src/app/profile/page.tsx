...
export default function ProfilePage() {
    ...
    return (
        <div className="mx-auto w-11/12 py-8 bg-[#0F1518]">
            ...
            <div className="flex w-full gap-6 rounded-2xl border border-[#e6f0e6] bg-[#0f1518] p-8 shadow-md">
                {/* ส่วนกล่อง profile */}
                <div>
                    <img
                        src="@/src/app/favicon.ico" // ใส่ URL รูป
                        alt="Profile Picture"
                        className="h-48 w-48 rounded-xl object-cover border border-gray-700"
                    />
                </div>
                <div className="flex flex-col flex-1 justify-between ">
                    <div>
                        <div className="flex items-center gap-2 mb-1">
                            <div className="text-5xl font-bold text-[#e6f0e6]">
                                Tsuyu Asui
                            </div>
                            <BadgeIcon />
                        </div>
                        <div className="text-[#9aa6a8] text-xl mt-5 ">
                            Frog.ribbitribbit@mha.ac.th
                        </div>
                    </div>
                    <div className="flex h-1/4 gap-8">
                        <Link href="/profile/edit">
                            <button className="flex items-center h-full gap-3 rounded-lg bg-[#8fff9c] px-6 py-2 text-xl font-semibold text-[#0b0f12] cursor-pointer">
                                Edit
                        ...
                        <Link href="/main">
                            <button className="flex items-center h-full gap-2 rounded-lg bg-[#8fff9c] px-6 py-2 text-xl font-semibold text-[#0b0f12] cursor-pointer">
                                Subscription
                            </button>
                        </Link>
                    </div>
