        ...
        <div className="flex flex-col w-full text-[#E6F0E6] max-w-7xl font-sans pb-10">
            <Box mb={4}>
                <GenericBreadcrums items={[
                    ...
                    { label: "Triage & Fixed", href: undefined }
                ]} />
                <Typography variant="h4" sx={{ fontWeight: 900, color: "#FBFBFB", mt: 2 }}>Triage and Fixed</Typography>
            </Box>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 min-h-[650px] mt-2">
                ...
                <Box className="lg:col-span-4 bg-[#1E2429] rounded-2xl border border-[#404F57] overflow-hidden flex flex-col h-fit">
                    ...
                    <Box p={2} borderBottom="1px solid #404F57" bgcolor="#0B0F12" sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        <Typography variant="subtitle2" sx={{ fontWeight: 800, color: "#9AA6A8", fontSize: '11px', letterSpacing: 0.5 }}>
                            ISSUES ({totalCount})
                        </Typography>
                    ...
                    {/* List Area */}
                    <List sx={{ p: 0, minHeight: '480px', bgcolor: "#1A1F23" }}>
                        {isVulnLoading ? (
                    ...
                    {/* Pagination */}
                    <Box sx={{ p: 1, borderTop: "1px solid #404F57", bgcolor: "#0B0F12" }}>
                        <GenericPagination 
